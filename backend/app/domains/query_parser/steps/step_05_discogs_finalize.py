...
from app.domains.query_parser.compilation import looks_like_compilation
from app.domains.query_parser.steps.step_04_intent import classify_intent
...
async def validate_album_with_discogs(artist: str, album: str) -> bool:
    ...
    from app.domains.query_parser.discogs_service import get_artist_discography

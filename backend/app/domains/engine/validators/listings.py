...
from app.domains.engine.policies.eu_stores import ALLOWED_STORES
...
def global_fallback_matches_parsed_entity(
    *,
    ...
    from app.domains.engine.extraction.evidence_alignment import evidence_blob_matches_target_release

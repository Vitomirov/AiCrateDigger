...
``DATABASE_URL`` is set (see :func:`app.core.db.store_loader.seed_whitelist_stores_if_empty`).
...
Domain checks in :mod:`app.domains.engine.validators.listings` use the same domains the pipeline

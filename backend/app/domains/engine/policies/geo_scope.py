...
def sort_validated_listings_geo(
    ...
    *,
    ...
    :func:`app.domains.engine.policies.listing_rank.composite_listing_rank` so non-local
    ...
    from app.domains.engine.policies.listing_rank import composite_listing_rank, resolve_store_for_url

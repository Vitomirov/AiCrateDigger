...
ALLOWED_STORES: tuple[StoreEntry, ...] = (
    ...
    StoreEntry("Concerto", "concerto.nl", "NL", "western_europe", ("EU",), 9, listing_quality=9, city="Amsterdam"),
    StoreEntry(
        "Phonica Records",
        "phonica.co.uk",
        "GB",
    ...
    StoreEntry("Rush Hour", "rushhour.nl", "NL", "western_europe", ("EU",), 9, listing_quality=9, city="Amsterdam"),
    StoreEntry(
        "CDandLP",
        "cdandlp.com",
        "FR",
    ...
    StoreEntry("Clone", "clone.nl", "NL", "western_europe", ("EU",), 8, listing_quality=9, city="Rotterdam"),
    StoreEntry(
        "Piccadilly Records",
    ...
    StoreEntry("Boomkat", "boomkat.com", "GB", "uk", ("EU", "GB"), 8, listing_quality=9, city="Manchester"),
    StoreEntry(
        "Sister Ray",
        "sisterray.co.uk",
        "GB",
    ...
    StoreEntry("Sound Ohm", "soundohm.com", "IT", "southern_europe", ("EU",), 7, listing_quality=8, city="Milan"),
    StoreEntry(
        "Discos Revolver",
        "discosrevolver.com",
        "ES",
